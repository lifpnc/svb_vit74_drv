...
encoders=([
    ("encoder", 0,
     Subsignal("A", Pins("j7:0")), # J7.1
     Subsignal("B", Pins("j7:1")), # J7.2
 #    Subsignal("Z", Pins("j7:2")), # false
     IOStandard("LVCMOS33")),
    ("encoder", 1,
     Subsignal("A", Pins("j7:2")),  # J7.3
     Subsignal("B", Pins("j7:4")),  # J7.5
  #   Subsignal("Z", Pins("j7:6")),  # false
     IOStandard("LVCMOS33")
     ),
    ("encoder", 2,
     Subsignal("A", Pins("j7:5")),  # J7.6
     Subsignal("B", Pins("j7:6")),  # J7.7
#     Subsignal("Z", Pins("j8:2")),  # false
     IOStandard("LVCMOS33")
     ),
    ("encoder", 3,
     Subsignal("A", Pins("j8:0")),  # J8.1
     Subsignal("B", Pins("j8:1")),  # J8.2
#     Subsignal("Z", Pins("j8:6")),  # false
     IOStandard("LVCMOS33")
     ),
    ("encoder", 4,
     Subsignal("A", Pins("j8:2")),  # J8.3
     Subsignal("B", Pins("j8:4")),  # J8.5
#     Subsignal("Z", Pins("j1:14")),  # false
     IOStandard("LVCMOS33")
     ),
    ("encoder", 5,
     Subsignal("A", Pins("j8:5")),  # J8.6
     Subsignal("B", Pins("j8:6")),  # J8.7
 #    Subsignal("Z", Pins("j1:14")),  # false
     IOStandard("LVCMOS33")
     ),
])
