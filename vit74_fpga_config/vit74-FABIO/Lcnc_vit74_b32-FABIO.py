...
encoders=([
    ("encoder", 0,
     Subsignal("A", Pins("j7:1")), #F3
     Subsignal("B", Pins("j7:2")), #F1
     IOStandard("LVCMOS33")),
    ("encoder", 1,
     Subsignal("A", Pins("j7:3")),  # J2.1
     Subsignal("B", Pins("j7:5")),  # J2.2
     IOStandard("LVCMOS33")
     ),
    ("encoder", 2,
     Subsignal("A", Pins("j7:6")),  # J3.1
     Subsignal("B", Pins("j7:7")),  # J3.2
     IOStandard("LVCMOS33")
     ),
    ("encoder", 3,
     Subsignal("A", Pins("j8:1")),  # J4.1
     Subsignal("B", Pins("j8:2")),  # J4.2
     IOStandard("LVCMOS33")
     ),
    ("encoder", 4,
     Subsignal("A", Pins("j8:3")),  # J3.1
     Subsignal("B", Pins("j8:5")),  # J3.2
     IOStandard("LVCMOS33")
     ),
    ("encoder", 5,
     Subsignal("A", Pins("j8:6")),  # J4.1
     Subsignal("B", Pins("j8:7")),  # J4.2
     IOStandard("LVCMOS33")
     )
])
...
#gpios in
_gpios_in = [
    ("gpio_in", 0 , Pins("j5:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 1 , Pins("j5:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 2 , Pins("j5:3"), IOStandard("LVCMOS33")),
    ("gpio_in", 3 , Pins("j5:5"), IOStandard("LVCMOS33")),
    ("gpio_in", 4 , Pins("j5:6"), IOStandard("LVCMOS33")),
    ("gpio_in", 5 , Pins("j5:7"), IOStandard("LVCMOS33")),
    ("gpio_in", 6 , Pins("j6:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 7 , Pins("j6:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 8 , Pins("j6:3"), IOStandard("LVCMOS33")),
    ("gpio_in", 9 , Pins("j6:5"), IOStandard("LVCMOS33")),
    ("gpio_in",10 , Pins("j6:6"), IOStandard("LVCMOS33")),
    ("gpio_in",11 , Pins("j6:7"), IOStandard("LVCMOS33"))
]
...
_pwm_out = [ \
    ("pwm_out", 0, Pins("j1:9"), IOStandard("LVCMOS33")),
    ("pwm_out", 1, Pins("j1:10"), IOStandard("LVCMOS33")),
    ("pwm_out", 2, Pins("j1:11"), IOStandard("LVCMOS33"))
]

_ext_reset_in = [("ext_reset_in", 0, Pins("j1:12"), IOStandard("LVCMOS33"))]
...
def main():
    ...
    f=open("driver/include/configuration_auto.h","w")
...
// number of registers to be sent read from fpga, sum of all the ones so far\n")
    ...
    soc = BaseSoC(board=args.board, revision=args.revision,toolchain=args.toolchain,
    ...
    if args.build:
        builder.build(build_name="Lcnc",**builder_kargs)
